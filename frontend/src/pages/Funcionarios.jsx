...
import { Search, Plus, Edit2, Trash2, X, Check, AlertTriangle, Contact } from 'lucide-react';
...
function Funcionarios({ usuarioAtual }) {
  ...
  const fetchFuncionarios = async () => {
    try {
      setLoading(true);
      const url = busca ? `${API_URL}/funcionarios/?busca=${encodeURIComponent(busca)}` : `${API_URL}/funcionarios/`;

...
def fix_ferias():
    db_path = r'c:\Users\User\Desktop\App_Munaretto\clientes.db'
    if not os.path.exists(db_path):
        print("Local DB doesn't exist.")
        return
    ...
    conn.commit()
    print(f"Sucesso! Atualizados {updated} registros de férias com a data de retorno correta no banco local.")

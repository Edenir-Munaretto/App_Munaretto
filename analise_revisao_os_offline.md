...
| 2 — coerência offline/online | A5, A6, A7, A8 + filtros offline, Evidências offline, botão Impedir, guarda de clique | ⏳ Pendente |
...
| Logout/login e `limpa rPacote` quase duplicados (política inconsistente) | `db.js:87-95` vs `offline.js:249-260` |
